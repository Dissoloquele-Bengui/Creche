...
@section('titulo','Consultar Nota da Turma '.$turma->nome )
          ...
          <div class="col-md-12 my-4">
            ...
            <div class="card shadow">
                <div class="card-header d-flex justify-content-around">
                    <strong class="card-title">Caderneta de {{ $disciplina->nome }}</strong>
                  ...
                  <tbody>
                    @foreach ($alunos as $aluno)
                        <tr>
                            ...
                            <td class="text-justify">
                                <p class="mb-0 text-muted">{{$aluno->avaliacoes!=null ? $aluno->avaliacoes:0}}</p>
                            </td>
                        </tr>
