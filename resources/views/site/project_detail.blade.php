            ...
            <div class="slides-1 portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="{{asset(getProjectImage($projeto->id))}}" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('site/assets/img/projects/construction-1.jpg')}}" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('site/assets/img/projects/design-1.jpg')}}" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="{{asset('site/assets/img/projects/repairs-1.jpg')}}" alt="">
                </div>
