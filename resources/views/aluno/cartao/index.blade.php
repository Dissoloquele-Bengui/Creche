...
@section('titulo','Solicitação de Cartão')

@section('conteudo')
    <div class="card shadow mb-4">
        <div class="card-header">
            <strong class="card-title">Solicitação de Cartão</strong>
        </div>
        <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 justify-center">
                                    <a href="{{route('admin.aluno.emitirRupeCartao')}}"  class="btn btn-primary w-md">Emitir um rupe</a>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('admin.aluno.solicitaCartao')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
